...
set_property -dict {PACKAGE_PIN K13 IOSTANDARD LVDS_25} [get_ports dp_tx_aux_p]
set_property -dict {PACKAGE_PIN M13 IOSTANDARD LVCMOS25} [get_ports dp_tx_hp_detect]
